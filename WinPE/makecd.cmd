...
oscdimg.exe -n -bWinPE_%arch%\etfsboot.com WinPE_%arch%\ISO ISOs\%OUTFILE%
goto END
...
:DUPECHK
REM Controlla se è gia presente una ISO con lo stesso nome, in modo da evitare di sovrascriverla.
